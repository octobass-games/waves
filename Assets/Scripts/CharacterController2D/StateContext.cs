...
namespace Octobass.Waves.CharacterController2D
{
    public class StateContext
    {
        ...
        public DriverSnapshot DriverSnapshot;
        public MovementIntent MovementIntent;
        public CharacterController2DConfig CharacterControllerConfig;
        public bool JumpConsumed;

        public StateContext(Rigidbody2D body, Animator animator, DriverSnapshot driverSnapshot, MovementIntent movementIntent, CharacterController2DConfig characterControllerConfig)
        {
            Body = body;
            Animator = animator;
